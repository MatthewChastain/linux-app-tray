...
// BaseStatusIcon is passed as a parameter to tryCleanupOldIndicators()
// to avoid a circular import (indicatorStatusIcon.js imports util.js).
...
export function tryCleanupOldIndicators(indicatorType) {
    if (!indicatorType)
        return;
